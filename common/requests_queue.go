...
func NewOutboundReq(txID string, address, fromPoolAddr common.Address, coin types.Coin, coinAddr string, txBlockHeight int64, feeCoins types.Coins) OutBoundReq {
	return OutBoundReq{
		txID,
		address,
		fromPoolAddr,
