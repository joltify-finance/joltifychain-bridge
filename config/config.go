...
func DefaultConfig() Config {
	...
	flag.IntVar(&config.JoltifyChain.RollbackGap, "joltify-rollback-gap", 3, "delay the transaction process to prevent chain rollback")
	...
	flag.IntVar(&config.PubChainConfig.RollbackGap, "pubchain-rollback-gap", 3, "delay the transaction process to prevent chain rollback")
