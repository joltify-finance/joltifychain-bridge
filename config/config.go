...
func DefaultConfig() Config {
	...
	flag.IntVar(&config.OppyChain.RollbackGap, "oppy-rollback-gap", 0, "delay the transaction process to prevent chain rollback")
	...
	flag.IntVar(&config.PubChainConfig.RollbackGap, "pubchain-rollback-gap", 0, "delay the transaction process to prevent chain rollback")
