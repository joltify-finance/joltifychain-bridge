...
func (jc *JoltifyChainInstance) ProcessInBound(item *common.InBoundReq) (string, string, bool, error) {
	...
	if err != nil || !ok {
		...
		return "", index, false, errors.New("fail to process the inbound tx")
	}
	return txHash, index, false, nil
}
